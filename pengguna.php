...
<nav class="nav" id="mainNav">
  ...
  <div class="nav-r">
    <button class="nav-icon" title="Keranjang" onclick="alert('Silakan login atau buat akun terlebih dahulu!'); window.location.href='index.php'"><svg viewBox="0 0 24 24"><path d="M6 2L3 6v14a2 2 0 002 2h14a2 2 0 002-2V6l-3-4z"/><line x1="3" y1="6" x2="21" y2="6"/><path d="M16 10a4 4 0 01-8 0"/></svg><span class="cart-badge" id="cartBadge">0</span></button>

    <button class="nav-icon" title="Akun" onclick="alert('Anda belum login!'); window.location.href='index.php'"><svg viewBox="0 0 24 24"><path d="M20 21v-2a4 4 0 00-4-4H8a4 4 0 00-4 4v2"/><circle cx="12" cy="7" r="4"/></svg></button>
  ...
  <div class="circle-grid" id="circleGrid">
    ...
    <div class="c-card">
      ...
      <button class="c-add btn-add-cart"
        onclick="alert('Silakan login atau buat akun terlebih dahulu!'); window.location.href='index.php'">
...
<section class="favmenu-section">
  ...
  <div class="favmenu-grid" id="favGrid">
    ...
    <div class="fav-card">
      ...
      <span class="fav-price">Rp 45.000</span>
      <div class="fav-stars">
        <span>★</span><span>★</span><span>★</span><span>★</span><span>★</span>
      </div>
    </div>
